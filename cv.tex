...
\begin{cventries}
    \supervision{2025}
        ...
        {Open-source implementation of gravity and magnetic forward model of ellipsoids.}
        {Co-advised with \lindsey.}
...
\begin{cventries}
    ...
    \paper{2022}
        ...
        {F.J. Gonzalez, J.I. Gonzalez, \me, C.E. Repetto, B.J. Gómez and D.B. Berdichevsky}
        {10.1088/2516-1067/ac4f35}
...
% TODO: Add doi and link to poster
\talk{2026}
    {On the redesign of SimPEG’s inversion framework}
    {SEG: Critical Minerals Forum 2026}
    {}
    {}
...
\talk{2026}
    ...
    {EMIW 2026}
    {Poster: \DOI{10.5281/zenodo.21650406}}
    {10.5281/zenodo.21650406}

\talk{2026}
    {Open-source gravity and magnetic forward model of ellipsoids}
    {EGU 2026, General Assembly}
    {Abstract: \url{https://github.com/santisoler/emiw2026}}
    {10.5194/egusphere-egu26-8366}

\talk{2025}
    {3D geophysical inversions to characterize carbon sequestration potential of ultramafic rocks}
    {EGU 2025, General Assembly}
    {Poster: \DOI{10.6084/m9.figshare.28811126}}
    {10.5194/egusphere-egu25-13551}
