...
\usepackage{sectsty}
\sectionfont{\bfseries\LARGE\selectfont\sectionrule{0cm}{0cm}{-0.4em}{0.1mm}}
\subsectionfont{\mdseries\large\selectfont\uppercase}
...
\subsection{Conference Proceedings and Talks}
...
\begin{description}
    \item[Programming] Python, Numba, Cython, bash, FORTRAN, C
